...
const App = () => {
  ...
  const buttonsInfo = [
    { id: 1, text: '에게 미술', info: '지중해 중심부에 위치한 크레타 섬을 중심으로 일어난 에게 문명은 미술사에서 작은 부분을 차지하지만 중요하게 다뤄지는 이유는 에게 미술이 그리스 미술로 고스란히 이어지기 때문이다. 에게 미술은 현세적이면서 밝고 자유분방한 표현이 특징이며, 궁전 건축에 힘을 기울여 신전이 없으나 황금 보석의 장신구와 도기 등의 공예가 많다. 에게 해권은 이집트, 메소포타미아 등과 접촉하면서 크레타 미술에 있어서 해양적인 성격을 기반으로 오리엔트 미술과는 다른 미술을 키웠다.' },
